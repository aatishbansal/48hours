...
public interface WellnessRepository extends JpaRepository<WellnessEntity, Long>{
	...
	@Query(value ="select e4.name,e4.avatar, e.*,e2.recommend  from employeewellbeing.empwellness e , employeewellbeing.emprecommend e2, employeewellbeing.employee e4  where e.grade =e2.grade and e.remarks =e2.remarks \r\n"
