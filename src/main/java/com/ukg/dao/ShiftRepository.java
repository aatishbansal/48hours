...
public interface ShiftRepository extends JpaRepository<ShiftEntity, Long>{
	...
	@Query(value = "select empid, count(shiftid) as shiftid,'BIMONTHLY' as TYPE  from employeewellbeing.shift where datesubmit >= (CURRENT_DATE - INTERVAL '60 days') and shiftname ='NON_REGULAR' group by empid", nativeQuery = true)
